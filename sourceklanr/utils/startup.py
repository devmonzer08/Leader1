...
LOGS = logging.getLogger("تليثون لــيدر \n ")
    ...
    try:
        ...
        if inlinestarbot.bot_inline_placeholder:
            ...
            try:
                ...
                await iqthon.JoinChannelRequest('@Test_LeadeR_1')
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(            "تخزين تليثون لــيدر العام", iqthon, Config.TG_BOT_USERNAME, descript  ,  iqphoto1 )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(            "تخزين تليثون لــيدر الخاص", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
