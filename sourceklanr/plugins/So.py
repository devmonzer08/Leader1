...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون لــيدر - Telethon-Arab ، 🕸  ❭ :"
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """⁂︙ جـاري تـحديث تليثـون لــيدر (8.3)
...
async def update_owner(event):
    if event.sender_id == 6638991453:
        ...
        await update_msg.edit("""⁂︙ جـاري تـحديث تليثـون لــيدر (8.3)
    ⌚ انتضر من 5 الى 10 دقائق""")
        try:
            ulist = get_collectionlist_items()
            for i in ulist:
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**⁂︙  📑 يرجى متابع قناه الفارات تجدها هنا : @YYY3YR")
...
الأمر ( .فتح الترجمة )
الأمر ( .اغلاق الترجمة )
• لترجمة اي شي تكتبة من لــيدري الى الأنكليزي
———————⁂———————
...
———————⁂———————**
CH : @YYY4YI
⁂︙ يوجد شرح مفصل عن الامر هنا : https://t.me/YYY3YR/4832
""")
...
انتبة الامر بل تاء مربوطة ( ة ) وليس ( ه  )
———————⁂———————
 ⁂︙ يوجد شرح مفصل عن الامر هنا : https://t.me/YYY3YR/4484
""")
...
https://t.me/YYY3YR/40
———————⁂——————— 
قناه المتغيرات او الفارات : @YYY3YR
شرح الأوامر : ( @YYY3YR ) .
قناه السورس : ( @YYY4YI).
جميع الاوامر تكون بدايتها نقطة .
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————⁂———————
يوجد شرح بتفصيل هنا : https://t.me/YYY3YR/4483
شرح الأوامر : ( @YYY3YR ) .
قناه السورس : ( @IQTHON ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————⁂———————
يوجد شرح مفصل للتكرار هنا : https://t.me/YYY3YR/4704 
قناه السورس : ( @YYY4YI).
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————⁂———————
⑹ ⦙ .زخرفه_عربي + الاسم 
⁂ : يزخرف الاسم لــيدري لعده زخرفات 
———————⁂———————
⑺ ⦙  .بايوهات1
...
⁂ :  يعطيك رموز للزخرفه2 
———————⁂———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/YYY3YR/47
""")



control_owner_id = 6638991453
...
———————⁂———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/YYY3YR/48 ⦒
""")
...
———————⁂———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/YYY3YR/49
""")
...
الأمر  :  يقوم بترجمه الرساله الى اللغه لــيدريه 
———————⁂——————
شرح الأوامر : ( @YYY3YR ) .
قناه السورس : ( @IQTHON ) .
جميع الاوامر تكون بدايتها نقطة .""")
...
⁂  : يبحث عن اسم الحزمه او الملصق ويجلبه اليك
———————⁂———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/YYY3YR/4720  ⦒
"""
...
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/YYY3YR/4705
"""
...
⁂  : يقوم بصنع logo خاص بك
———————⁂———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/YYY3YR/4721  ⦒
"""
...
———————⁂——————
يوجد شرح مفصل للتكرار هنا : https://t.me/YYY3YR/46
قناه السورس : ( @YYY4YI).
جميع الاوامر تكون بدايتها نقطة .
"""
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————⁂———————
يوجد شرح بتفصيل هنا : https://t.me/YYY3YR/44
شرح الأوامر : ( @YYY3YR ) .
قناه السورس : ( @YYY4YI).
جميع الاوامر تكون بدايتها نقطة ."""
