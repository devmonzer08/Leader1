...
try:
    LOGS.info("بدء تنزيل تليثون لــيدر")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["YYY4YI","YYYYU4I","YYYR4I","IIIIF3I","YYY3YR","O5G_O"]
    ...
    print(f"<b> 🔱 اهلا بك لقد نصبت تليثون لــيدر بنجاح ☸️ اذهب الى قناتنا لمعرفة المزيـد v8.3 🔆. </b>\n CH : https://t.me/YYY4YI")
    await verifyLoggerGroup()
